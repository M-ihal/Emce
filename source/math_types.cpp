...
// NOTE: Generated by chat gpt, verify
mat4 mat4::rotate(float x, float y, float z) {
    ...
    // Manually compute the result of combining the rotation matrices for X, Y, Z axes
    result.e00 = cy * cz;
    result.e01 = cy * sz;
    result.e02 = -sy;
    result.e03 = 0.0f;

    result.e10 = sx * sy * cz - cx * sz;
    result.e11 = sx * sy * sz + cx * cz;
    result.e12 = sx * cy;
    result.e13 = 0.0f;

    result.e20 = cx * sy * cz + sx * sz;
    result.e21 = cx * sy * sz - sx * cz;
    result.e22 = cx * cy;
    result.e23 = 0.0f;
